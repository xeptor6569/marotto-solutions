...
export type SettingsTabId = 'business' | 'appearance' | 'site' | 'billing' | 'documents' | 'storage' | 'account';

const VALID_TABS: SettingsTabId[] = ['business', 'appearance', 'site', 'billing', 'documents', 'storage', 'account'];
